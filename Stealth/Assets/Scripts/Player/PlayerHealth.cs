...
public class PlayerHealth : MonoBehaviour
{
    ...
    PlayerMovement playerMovement = null;               // Reference to the player movement script.
    HashIDs hash = null;                                // Reference to the HashIDs.
    SceneFadeInOut sceneFadeInOut = null;               // Reference to the SceneFadeInOut script.
    LastPlayerSighting lastPlayerSighting = null;       // Reference to the LastPlayerSighting script.
