...
{
    [SerializeField] float maximumDamage = 120f;                    // The maximum potential damage per shot.
    [SerializeField] float minimumDamage = 45f;                     // The minimum potential damage per shot.
    [SerializeField] AudioClip shotClip = null;                     // An audio clip to play when a shot happens.
    [SerializeField] float flashIntensity = 3f;                     // The intensity of the light when the shot happens.
    [SerializeField] float fadeSpeed = 10f;                         // How fast the light will fade after the shot.

    Animator anim = null;                                           // Reference to the animator.
    HashIDs hash = null;                                            // Reference to the HashIDs script.
    LineRenderer laserShotLine = null;                              // Reference to the laser shot line renderer.
    Light laserShotLight = null;                                    // Reference to the laser shot light.
    ...
    float scaledDamage = 0f;                                        // Amount of damage that is scaled by the distance from the player.
