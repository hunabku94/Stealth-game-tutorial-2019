...
public class EnemySight : MonoBehaviour
{
    ...
    LastPlayerSighting lastPlayerSighting = null;               // Reference to last global sighting of the player.
    GameObject player = null;                                   // Reference to the player.
    Animator playerAnim = null;                                 // Reference to the player's animator component.
    PlayerHealth playerHealth = null;                           // Reference to the player's health script.
