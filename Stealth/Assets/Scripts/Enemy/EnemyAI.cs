...
public class EnemyAI : MonoBehaviour
{
    ...
    PlayerHealth playerHealth = null;                       // Reference to the PlayerHealth script.
    LastPlayerSighting lastPlayerSighting = null;           // Reference to the last global sighting of the player.
