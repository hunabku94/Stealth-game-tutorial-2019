...
{
    [SerializeField] float doorSpeed = 7f;  // How quickly the inner doors will track the outer doors.

    Transform leftOuterDoor = null;         // Reference to the transform of the left outer door.
    Transform rightOuterDoor = null;        // Reference to the transform of the right outer door.
    Transform leftInnerDoor = null;         // Reference to the transform of the left inner door.
    Transform rightInnerDoor = null;        // Reference to the transform of the right inner door.
    float leftClosedPosX = 0f;              // The initial x component of position of the left doors.
    float rightClosedPosX = 0f;             // The initial x component of position of the right doors.
