...
{
    [SerializeField] GameObject laser = null;           // Reference to the laser that can we turned off at this switch.
    [SerializeField] Material unlockedMat = null;       // The screen's material to show the laser has been unloacked.
