...
public class LastPlayerSighting : MonoBehaviour
{
    ...
    AlarmLight alarm = null;                                            // Reference to the AlarmLight script.
    Light mainLight = null;                                             // Reference to the main light.
    AudioSource panicAudio = null;                                      // Reference to the AudioSource of the panic msuic.
    AudioSource[] sirens = null;                                        // Reference to the AudioSources of the megaphones.
